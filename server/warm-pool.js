...
async function prewarm() {
    ...
    try {
        ...
        const filterOffer = (o) => {
            ...
            // Exclude RTX 5060 / 5060 Ti as requested by user
            if (o.gpu_name && (o.gpu_name.includes('5060'))) {
                reasons.push('GPU excluded: RTX 5060 series');
                        ...
                        if (!allowed) {
                            ...
                            try {
                                ...
                                if (allowedHosts.length > 0) {
                                    const disallowed = hosts.filter(h => !allowedHosts.some(a => h.includes(a)));
