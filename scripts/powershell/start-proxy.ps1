...
$env:COMFYUI_PROVISION_SCRIPT = if ($env:COMFYUI_PROVISION_SCRIPT) { $env:COMFYUI_PROVISION_SCRIPT } else { "https://raw.githubusercontent.com/pimpsmasterson/working-prototype-ai-kingz/main/scripts/setup.sh" }
